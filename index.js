...
// // Use Object.assign to merge these three objects into a single new object.
//Then use object destructuring to split them out into separate variables.
//Finally use the enhanced object literal syntax to merge the variables back into
//three more objects which are identical to the originals.
...
const rectToCorners = (x, y, width, height) => {
    const topLeft = [x, y];
